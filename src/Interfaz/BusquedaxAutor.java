...
class BuscarxAutor extends JFrame{
	...
	private JPanel panelCentro1;
	private JPanel panelCentro;
	private JPanel panelauxiliar;
	private JPanel panelauxiliar2;
	public BuscarxAutor(String text, int opc, String[][] filas) {
		super(text);
		...
		Font auxFont3 = admin.getFont();
		admin.setFont(new Font(auxFont3.getFontName(), Font.HANGING_BASELINE, 10));
		
		anonimo = new JLabel("<html><body><br><u>Anonimo:</u></body></html>");
		anonimo.setForeground(Color.BLACK);
		Font auxFont4 = anonimo.getFont();
		anonimo.setFont(new Font(auxFont4.getFontName(), Font.HANGING_BASELINE, 10));
		
		JLabel espacios2 = new JLabel("<html><body><br></body></html>");
		
		volver = new JButton("Menu Usuario");
		volver.setForeground(Color.BLUE);
		Font auxFont5 = nombreAplicacion.getFont();
		volver.setFont(new Font(auxFont5.getFontName(), Font.ITALIC, 10));
		
		cerrarSesion = new JButton("Cerrar Sesion");
		cerrarSesion.setForeground(Color.BLUE);
		Font auxFont6 = cerrarSesion.getFont();
		cerrarSesion.setFont(new Font(auxFont6.getFontName(), Font.ITALIC, 10));
		...
		Font auxFont8 = Busqueda.getFont();
		Busqueda.setFont(new Font(auxFont8.getFontName(), Font.HANGING_BASELINE, 10));
		...
		this.busquedaxcancion.setActionCommand("CAMBIOPANTALLA");
	...
	public void setControladorBusquedaAutor(ActionListener c) {
...
/**
public class BusquedaxAutor {
    public static void main(String [] args) {
        Runnable runner = new Runnable() {
            public void run() {
            	String[][] prueba = {{"0", "Pepe", "Hola Mundo"}, {"1", "Miguel",}, {"2", "Mateo"}, {"3", "Franccy"}};
            	@SuppressWarnings("unused")
                final BuscarxAutor ventana = new BuscarxAutor ("Pagina Principal", false, prueba);
            }
        };
