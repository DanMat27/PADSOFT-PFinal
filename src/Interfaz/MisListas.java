...
class MisListas extends JFrame{
	...
	public MisListas(String text, String[][] filas) {
		super(text);
		...
		titulo = new JLabel("<html><body><br>Listas de Reproducción:</body></html>");
	...
	public void setControladorListas(ActionListener c) {
