...
class Notif_pagina extends JFrame{
	...
	public Notif_pagina(String text, boolean admin, String[][] filas) {
		super(text);
		...
		titulo = new JLabel("<html><body><br>Notificaciones recibidas mientras no estabas:</body></html>");
		...
		String[] tablas = {"Id", "Usuario", "Notificacion"};		
	...
	public void setControladorNotif(ActionListener c) {
...
public class Notificaciones {
    public static void main(String [] args) {
        Runnable runner = new Runnable() {
            public void run() {
            	String[][] prueba = {{"0", "Pepe", "Hola Mundo"}, {"1", "Miguel", "Hey"}, {"2", "Mateo", "Sad"}, {"3", "Franccy", "Activos"}};
            	@SuppressWarnings("unused")
                final Notif_pagina ventana = new Notif_pagina ("Pagina Principal", false, prueba);
            }
        };
