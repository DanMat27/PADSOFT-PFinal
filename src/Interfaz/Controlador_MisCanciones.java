...
public class Controlador_MisCanciones implements ActionListener, WindowListener  {
	private Canciones vista;
	private Sistema sistema;
	
	public Controlador_MisCanciones(Canciones vista, Sistema sistema) {
		this.vista = vista;
