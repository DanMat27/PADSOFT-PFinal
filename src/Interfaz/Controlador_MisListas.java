...
public class Controlador_MisListas implements ActionListener, WindowListener  {
	private MisListas vista;
	private Sistema sistema;
	
	public Controlador_MisListas(MisListas vista, Sistema sistema) {
		this.vista = vista;
