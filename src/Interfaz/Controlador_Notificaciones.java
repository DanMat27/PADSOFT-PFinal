...
public class Controlador_Notificaciones implements ActionListener, WindowListener  {
	private Notif_pagina vista;
	private Sistema sistema;
	
	public Controlador_Notificaciones(Notif_pagina vista, Sistema sistema) {
		this.vista = vista;
