...
class Albumes extends JFrame{
	...
	public Albumes(String text, String[][] filas) {
		super(text);
		...
		titulo = new JLabel("<html><body><br>Lista de tus Albumes:</body></html>");
	...
	public void setControladorAlbumes(ActionListener c) {
